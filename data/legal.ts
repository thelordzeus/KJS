...
// Dependencies
import { PEACE_NGO_EMAIL, PEACE_NGO_PHONE } from './ngo';

export const PEACE_NGO_TERMS_AND_CONDITIONS: TermsAndConditionsData = [
	{
		title: 'Intellectual Property Rights',
		descriptions: [
			'Other than the content you own, under these terms, Peace NGO and/or its licensors own all the intellectual property rights and materials contained on this website.',
	...
	},
	{
		title: 'Your Content',
		descriptions: [
			'In these website standard terms and conditions, "Your Content" shall mean any audio, video, text, images, or other material you choose to display on this website. By displaying Your Content, you grant Peace NGO a non-exclusive, worldwide irrevocable, sub-licensable license to use, reproduce, adapt, publish, translate, and distribute it in any and all media.',
			'Your Content must be your own and must not be invading any third-party rights. Peace NGO reserves the right to remove any of Your Content from this website at any time without notice.',
		],
	},
	{
		title: 'No warranties',
		descriptions: [
			'This website is provided "as is," with all faults, and Peace NGO expresses no representations or warranties, of any kind related to this website or the materials contained on this website. Also, nothing contained on this website shall be interpreted as advising you.',
		],
	},
	{
		title: 'Limitation of liability',
		descriptions: [
			'In no event shall Peace NGO, nor any of its officers, directors, and employees, be held liable for anything arising out of or in any way connected with your use of this website, whether such liability is under contract. Peace NGO, including its officers, directors, and employees, shall not be held liable for any indirect, consequential, or special liability arising out of or in any way related to your use of this website.',
		],
	},
	{
		title: 'Indemnification',
		descriptions: [
			'You hereby indemnify to the fullest extent Peace NGO from and against any and/or all liabilities, costs, demands, causes of action, damages, and expenses arising in any way related to your breach of any of the provisions of these terms.',
		],
	},
];

export const PEACE_NGO_PRIVACY_POLICY: PrivacyPolicyData = [
	{
	...
	},
	{
		...
		descriptions: [
			'Peace NGO may collect and use users’ personal information for the following purposes:',
	...
	},
	{
		title: 'Contact Us',
		descriptions: [
			`If you have any questions or concerns regarding our Privacy Policy, please contact us at ${PEACE_NGO_EMAIL} or ${PEACE_NGO_PHONE}.`,
		],
	},
];
